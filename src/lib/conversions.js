...
export const celsiusToFahrenheit = (celsius) => {
  ...
  export const conversionOptions = {
    ...
    volume: [
    { from: 'Fluid Ounces', to: 'Milliliters', convert: fluidOuncesToMilliliters },
    { from: 'Pints', to: 'Liters', convert: pintsToLiters },
    { from: 'Gallons', to: 'Liters', convert: gallonsToLiters }],
  
    area: [
    { from: 'Square Feet', to: 'Square Meters', convert: squareFeetToSquareMeters },
    { from: 'Square Yards', to: 'Square Meters', convert: squareYardsToSquareMeters },
